...
//   static int    GetWorkers(XrdProofServProxy *, XrdOucString &wantWorkers, XrdOucString &workers);
   int    GetWorkers(XrdProofServProxy *, XrdOucString &wantWorkers, XrdOucString &workers);
