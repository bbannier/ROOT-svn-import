...
{
   // the destructor (delete the Optimizer, store the graph and .. delete it)
...
//_______________________________________________________________________
Double_t TMVA::Optimizer::GetFOM()
{
...
//_______________________________________________________________________
void TMVA::Optimizer::GetMVADists()
{
...
//_______________________________________________________________________
Double_t TMVA::Optimizer::GetSeparation()
{
...
//_______________________________________________________________________
Double_t TMVA::Optimizer::GetROCIntegral() 
{
   ...
   if (0){
      ...
      if ( (fMvaSigFineBin->GetXaxis()->GetXmin() !=  fMvaBkgFineBin->GetXaxis()->GetXmin()) ||
         ...
         std::cout << " Error in Optimizer GetROCIntegral, unequal histograms for sig and bkg.." << std::endl;
         exit(1);
      }else{
...
//_______________________________________________________________________
Double_t TMVA::Optimizer::GetSigEffAt(Double_t bkgEff) 
{
   ...
   if ( (fMvaSigFineBin->GetXaxis()->GetXmin() !=  fMvaBkgFineBin->GetXaxis()->GetXmin()) ||
        (fMvaSigFineBin->GetNbinsX() !=  fMvaBkgFineBin->GetNbinsX()) ){
      std::cout << " Error in Optimizer GetSigEffAt, unequal histograms for sig and bkg.." << std::endl;
      exit(1);
   }else{
