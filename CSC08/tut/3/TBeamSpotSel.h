...
private :
   ...
   TH2*     fBeamSpotX_Time; // vtx0.x vs time
   TH2*     fBeamSpotY_Time; // vtx0.y vs time
   TH2*     fBeamSpotZ_Time; // vtx0.z vs time
   TH3*     fBeamSpotXYZ; // vtx0 x vs y vs z

public:
   TBeamSpotSel(TTree * /*tree*/ =0):
      fChain(0), fEventInfo(0), fBranchEventInfo(0),
      fBeamSpotX_Time(0), fBeamSpotY_Time(0), fBeamSpotZ_Time(0),
      fBeamSpotXYZ(0)
   { }
