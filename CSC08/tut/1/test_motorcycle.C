...
void setproperties(TMotorcycle m, const char *brand, const char *model, Int_t cap, Float_t power)
{
   ...
   // declare the TMotorcycle class
   TMotorcycle mybike;
   // set it to the one passed in argument
   mybike = m;
   // set the brand
...
void printinfos(TMotorcycle m)
{
   ...
   // declare the class (using the one passed in argument)
...
void test_motorcycle()
{
   ...
   TMotorcycle mybike("Honda", "VTX1300S", 1312, 55);
