...
class procRates : public TSelector {
public :
...
private :
   ...
   Float_t *y1;
   Int_t fMaxTime;
   ClassDef(procRates,0);
};

#endif

#ifdef procRates_cxx
void procRates::Init(TTree *tree)
{
