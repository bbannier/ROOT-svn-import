...
//-------------------------------------------------------------------------------
Reflex::Function::Function( const Reflex::Dictionary& dictionary,
                            const Type & retType,
...
// Default constructor for a function type.
   : TypeBase(dictionary, BuildTypeName(retType, parameters, QUALIFIED | SCOPED).c_str(), 0, functionType, ti, Type(), (REPRESTYPE) '1'),
