...
//-------------------------------------------------------------------------------
Reflex::VariableBuilderImpl::VariableBuilderImpl( const Reflex::Dictionary& dictionary,
                                                  const char * nam,
                                                        const Type & typ,
                                                 size_t offs,
...
//-------------------------------------------------------------------------------
Reflex::VariableBuilder::VariableBuilder( const Reflex::Dictionary& dictionary,
                                          const char * nam, 
                                                const Type & typ,
                                         size_t offs,
                                         unsigned int modifiers):
