...
//-------------------------------------------------------------------------------
void Reflex::Class::AddFunctionMember(Member* out_mbr,
                                      const char * nam,
                                      const Type typ,
                                      StubFunction stubFP,
                                      void * stubCtx /* = 0 */,
...
// Add function member to this class
   ...
   if (out_mbr->IsConstructor())    fConstructors.push_back(*out_mbr);
   else if (out_mbr->IsDestructor()) fDestructor = *out_mbr;
}
