 ...
 **************************************************************************/
#ifdef G__WIN32
G__DECL_API(59, int, G__fprintf, (FILE* fp,char* fmt,...));
...
G__DECL_API(134, long, G__getFuncNow, (void));
...
G__DECL_API(171, int, G__setbreakpoint, (char *breakline,char *breakfile));
