...
$(RAUTHDS):     $(RAUTHH) $(RAUTHL) $(RAUTHO) $(ROOTCINTNEW)
		@echo "Generating dictionary $@..."
		$(ROOTCINTNEW) -f $@ -o "$(RAUTHO)" -c $(RAUTHH) $(RAUTHL)
...
$(AFSAUTHDS):   $(AFSAUTHH) $(AFSAUTHL) $(AFSAUTHO) $(ROOTCINTNEW)
		@echo "Generating dictionary $@..."
		$(ROOTCINTNEW) -f $@ -o "$(AFSAUTHO)" -c $(AFSAUTHH) $(AFSAUTHL)
