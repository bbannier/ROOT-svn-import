...
*
******************************************************************/
int Cint::Internal::G__isenclosingclass(const ::Reflex::Scope& enclosingtagnum,
                                        const ::Reflex::Scope& env_tagnum)
{
...
*
******************************************************************/
int Cint::Internal::G__isenclosingclassbase(const ::Reflex::Scope& enclosingtagnum,
                                            const ::Reflex::Scope& env_tagnum)
{
#ifdef __GNUC__
#else
...
* G__add_scopemember()
******************************************************************/
::Reflex::Member Cint::Internal::G__add_scopemember(::Reflex::Scope &envvar
                        ,const char *varname
...
******************************************************************/
static void G__add_anonymousunion(const ::Reflex::Type &uniontype
...
#ifdef __GNUC__
#else
#pragma message(FIXME("NEED TO ADD BASE CLASS! (use the ClassBuilder/G__defining_thiny, Luke)"))
#endif
            //lstore_tagnum.AddBase(baseclass_scope, 0, modifiers);
          }
        }
      }
 ...
 * G__callfunc0()
 ******************************************************************/
int Cint::Internal::G__callfunc0(G__value *result,const ::Reflex::Member &ifunc
                 ,G__param *libp,void *p,int funcmatch)
{
  ...
  if(-1==G__get_funcproperties(ifunc)->entry.size) {
    ...
    stat=G__interpret_func(result,libp,0 /* ifunc->hash[ifn] */
