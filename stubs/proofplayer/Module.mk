...
$(PROOFPLAYERDS): $(PROOFPLAYERH) $(PROOFPLAYERL) $(PROOFPLAYERO) $(ROOTCINTNEW)
		@echo "Generating dictionary $@..."
		$(ROOTCINTNEW) -f $@ -o "$(PROOFPLAYERO)" -c $(PROOFPLAYERH) $(PROOFPLAYERL)
...
$(PROOFDRAWDS): $(PROOFDRAWH) $(PROOFDRAWL) $(PROOFDRAWO) $(ROOTCINTNEW)
		@echo "Generating dictionary $@..."
		$(ROOTCINTNEW) -f $@ -o "$(PROOFDRAWO)" -c $(PROOFDRAWH) $(PROOFDRAWL)
