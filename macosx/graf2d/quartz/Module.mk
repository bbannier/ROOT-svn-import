...
QUARTZSOBJCPP   := $(wildcard $(MODDIRS)/*.mm)
QUARTZOBJCPPO   := $(QUARTZSOBJCPP:.mm=.o)
...
$(QUARTZLIB):      $(QUARTZO) $(QUARTZOBJCPPO) $(QUARTZDO) $(ORDER_) $(MAINLIBS) $(QUARTZLIBDEP)
		@$(MAKELIB) $(PLATFORM) $(LD) "$(LDFLAGS)"  \
         "$(SOFLAGS)" libGQUARTZ.$(SOEXT) $@  "$(QUARTZO) $(QUARTZOBJCPPO) -framework Cocoa $(QUARTZDO) $(QUARTZLIBEXTRA)"
...
distclean-$(MODNAME): clean-$(MODNAME)
		@rm -f $(QUARTZDEP) $(QUARTZDS) $(QUARTZDH) $(QUARTZLIB) $(QUARTZMAP)
