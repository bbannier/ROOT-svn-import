...
TestPad::TestPad(UInt_t w, UInt_t h)
{
   fViewW = w;
   fViewH = h;
...
//______________________________________________________________________________
const char *TestPad::GetName() const
{
   return "iOSPad";
}

//______________________________________________________________________________
const char *TestPad::GetTitle() const 
{
   return "iOSPad";
}

//______________________________________________________________________________
void TestPad::Clear(Option_t *)
{
...
//______________________________________________________________________________
void TestPad::SetViewWH(UInt_t viewW, UInt_t viewH)
{
   fViewW = viewW;
   fViewH = viewH;
...
//______________________________________________________________________________
UInt_t TestPad::GetWw() const
{
   return fViewW;
}

//______________________________________________________________________________
UInt_t TestPad::GetWh() const
{
   return fViewH;
}

//______________________________________________________________________________
void TestPad::SetFixedAspectRatio(Bool_t fixed)
{
...
//______________________________________________________________________________
Double_t TestPad::PadtoX(Double_t x) const
{
...
//______________________________________________________________________________
Double_t TestPad::PadtoY(Double_t y) const
{
...
//______________________________________________________________________________
Double_t TestPad::XtoPad(Double_t x) const
{
...
//______________________________________________________________________________
Double_t TestPad::YtoPad(Double_t y) const
{
...
//______________________________________________________________________________
Int_t TestPad::UtoPixel(Double_t u) const
{
   Double_t val;
   if (fAbsCoord)
...
//______________________________________________________________________________
Int_t TestPad::VtoPixel(Double_t v) const
{
   Double_t val;
   if (fAbsCoord)
...
//______________________________________________________________________________
Int_t TestPad::XtoAbsPixel(Double_t x) const
{
...
//______________________________________________________________________________
Int_t TestPad::YtoAbsPixel(Double_t y) const
{
...
//______________________________________________________________________________
Int_t TestPad::XtoPixel(Double_t x) const
{
   Double_t val;
   if (fAbsCoord)
...
//______________________________________________________________________________
Int_t TestPad::YtoPixel(Double_t y) const
{
   Double_t val;
   if (fAbsCoord)
...
//______________________________________________________________________________
Double_t TestPad::PixeltoX(Int_t px)
{
   if (fAbsCoord)
...
//______________________________________________________________________________
Double_t TestPad::PixeltoY(Int_t py)
{
   if (fAbsCoord)
...
//______________________________________________________________________________
void TestPad::SetLogx(Int_t value)
{
...
//______________________________________________________________________________
void TestPad::SetLogy(Int_t value)
{
...
//______________________________________________________________________________
void TestPad::SetLogz(Int_t value)
{
...
//______________________________________________________________________________
void TestPad::SetPad(Double_t xlow, Double_t ylow, Double_t xup, Double_t yup)
{
...
//______________________________________________________________________________
void TestPad::SetPad(const char *, const char *, Double_t xlow, Double_t ylow, Double_t xup,
...
//______________________________________________________________________________
void TestPad::SetVertical(Bool_t vert)
{
...
//______________________________________________________________________________
void TestPad::GetRange(Double_t &x1, Double_t &y1, Double_t &x2, Double_t &y2)
{
...
//______________________________________________________________________________
void TestPad::Range(Double_t x1, Double_t y1, Double_t x2, Double_t y2)
{
...
//______________________________________________________________________________
void TestPad::GetRangeAxis(Double_t &xmin, Double_t &ymin, Double_t &xmax, Double_t &ymax)
{
...
//______________________________________________________________________________
void TestPad::RangeAxis(Double_t xmin, Double_t ymin, Double_t xmax, Double_t ymax)
{
...
//______________________________________________________________________________
void TestPad::GetPadPar(Double_t &xlow, Double_t &ylow, Double_t &xup, Double_t &yup)
{
...
//______________________________________________________________________________
void TestPad::SetFillStyle(Style_t fillStyle)
{
...
//______________________________________________________________________________
void TestPad::SetEditable(Bool_t mode)
{
...
//______________________________________________________________________________
void TestPad::SetView(TView *view)
{
...
//______________________________________________________________________________
void TestPad::ResizePad(Option_t *)
{
   // Compute pad conversion coefficients.
   //
...
//______________________________________________________________________________
TObject *TestPad::GetPrimitive(const char *name) const
{
...
//______________________________________________________________________________
void TestPad::PaintBox(Double_t x1, Double_t y1, Double_t x2, Double_t y2, Option_t *option)
{
...
//______________________________________________________________________________
void TestPad::PaintFillArea(Int_t, Float_t *, Float_t *, Option_t *)
{
...
//______________________________________________________________________________
void TestPad::PaintFillArea(Int_t nn, Double_t *xx, Double_t *yy, Option_t *)
{
   // Paint fill area in CurrentPad World coordinates.
...
//______________________________________________________________________________
void TestPad::PaintPadFrame(Double_t xmin, Double_t ymin, Double_t xmax, Double_t ymax)
{
...
//______________________________________________________________________________
void TestPad::PaintLine(Double_t x1, Double_t y1, Double_t x2, Double_t y2)
{
...
//______________________________________________________________________________
void TestPad::PaintLineNDC(Double_t u1, Double_t v1,Double_t u2, Double_t v2)
{
...
//______________________________________________________________________________
void TestPad::PaintLine3D(Float_t *p1, Float_t *p2)
{
...
//______________________________________________________________________________
void TestPad::PaintLine3D(Double_t *p1, Double_t *p2)
{
   // Paint 3-D line in the CurrentPad.
...
//______________________________________________________________________________
void TestPad::PaintPolyLine(Int_t n, Float_t *x, Float_t *y, Option_t *)
{
...
//______________________________________________________________________________
void TestPad::PaintPolyLine(Int_t n, Double_t *x, Double_t *y, Option_t *option)
{
   // Paint polyline in CurrentPad World coordinates.
   //
...
//______________________________________________________________________________
void TestPad::PaintPolyLineNDC(Int_t n, Double_t *x, Double_t *y, Option_t *)
{
...
//______________________________________________________________________________
void TestPad::PaintPolyLine3D(Int_t n, Double_t *p)
{
...
//______________________________________________________________________________
void TestPad::PaintPolyMarker(Int_t nn, Float_t *x, Float_t *y, Option_t *)
{
...
//______________________________________________________________________________
void TestPad::PaintPolyMarker(Int_t nn, Double_t *x, Double_t *y, Option_t *)
{
   // Paint polymarker in CurrentPad World coordinates.
...
//______________________________________________________________________________
TH1F *TestPad::DrawFrame(Double_t xmin, Double_t ymin, Double_t xmax, Double_t ymax, const char *title)
{
   //  Draw a pad frame
   //
   //  Compute real pad range taking into account all margins
   //  Use services of TH1F class
   TestPad *padsav = (TestPad*)gPad;
   if (this !=  padsav) {
...
//______________________________________________________________________________
void TestPad::RedrawAxis(Option_t *option)
{
...
//______________________________________________________________________________
TObject *TestPad::FindObject(const char *name) const
{
...
//______________________________________________________________________________
TObject *TestPad::FindObject(const TObject *obj) const
{
   return fPrimitives.FindObject(obj);
}

//___________________________________________________________
Int_t TestPad::Clip(Float_t *x, Float_t *y, Float_t xclipl, Float_t yclipb, Float_t xclipr, Float_t yclipt)
{
...
//___________________________________________________________
Int_t TestPad::Clip(Double_t *x, Double_t *y, Double_t xclipl, Double_t yclipb, Double_t xclipr, Double_t yclipt)
{
   // Clipping routine: Cohen Sutherland algorithm.
   //
   //   If Clip ==2 the segment is outside the boundary.
...
//___________________________________________________________
Int_t TestPad::ClippingCode(Double_t x, Double_t y, Double_t xcl1, Double_t ycl1, Double_t xcl2, Double_t ycl2)
{
...
//___________________________________________________________
Int_t TestPad::ClipPolygon(Int_t n, Double_t *x, Double_t *y, Int_t nn, Double_t *xc, Double_t *yc, Double_t xclipl, Double_t yclipb, Double_t xclipr, Double_t yclipt)
{
...
//______________________________________________________________________________
void TestPad::PaintBorder(Color_t color, Bool_t tops)
{
...
//______________________________________________________________________________
void TestPad::PaintFillAreaHatches(Int_t nn, Double_t *xx, Double_t *yy, Int_t FillStyle)
{
...
//______________________________________________________________________________
void TestPad::PaintHatches(Double_t dy, Double_t angle,
...
//______________________________________________________________________________
TVirtualViewer3D *TestPad::GetViewer3D(Option_t *)
{
   if (!fViewer3D)
