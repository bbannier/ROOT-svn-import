void create_pad_frame_gradient()
{
   ...
   new TColorGradient(1004, TColorGradient::kGDHorizontal, 4, locations, colorIndices, kTRUE);
}
...
void create_pad_gradient()
{
   ...
   new TColorGradient(1005, TColorGradient::kGDVertical, 2, locations, colorIndices, kTRUE);
}
...
void grad()
{
   ...
   new TColorGradient(1006, TColorGradient::kGDVertical, 3, lengths, colorIndices, kTRUE);
