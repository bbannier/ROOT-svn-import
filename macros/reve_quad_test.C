...
TEveQuadSet* reve_quad_test_emc(Float_t x=0, Float_t y=0, Float_t z=0,
				  Int_t num=100)
{
  TRandom r(0);
...
TEveQuadSet* reve_quad_test_circ()
{
  TRandom r(0);
...
TEveQuadSet* reve_quad_test_hex(Float_t x=0, Float_t y=0, Float_t z=0,
				  Int_t num=100, Bool_t register=kTRUE)
{
  TRandom r(0);
...
TEveQuadSet* reve_quad_test_hexid(Float_t x=0, Float_t y=0, Float_t z=0,
				    Int_t num=100, Bool_t register=kTRUE)
{
  TRandom r(0);
