...
namespace TMVA {
   ...
   public:
     ...
     //default constructor
     OptimizerFOM(MethodBase* const method, TString fomType, std::vector<Float_t> & fomVsIter);
   ...
   private:
     ...
     std::vector<Float_t> &fFOMvsIter;  // vector that stores all calcualted FOM values
