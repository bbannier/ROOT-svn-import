...
void addDataInputTests( UnitTestSuite& TMVA_test, bool full=true)
{
   ...
   TMVA_test.addTest(new MethodUnitTestWithComplexData(TString("nvar50_sig1_sig2_bgd1_bgd2"), TString("nTrain_Signal=500:nTrain_Background=500:SplitMode=random:NormMode=NumEvents:!V"), TMVA::Types::kBDT, "BDTNOCORR", "NTrees=50:BoostType=Grad" , 0.75, 0.98) );
