...
#ifndef ROOT_TTimeStamp64
#define ROOT_TTimeStamp64
...
Bool_t operator==(const TTimeStamp64 &lhs, const TTimeStamp64 &rhs);
Bool_t operator!=(const TTimeStamp64 &lhs, const TTimeStamp64 &rhs);
Bool_t operator< (const TTimeStamp64 &lhs, const TTimeStamp64 &rhs);
Bool_t operator<=(const TTimeStamp64 &lhs, const TTimeStamp64 &rhs);
Bool_t operator> (const TTimeStamp64 &lhs, const TTimeStamp64 &rhs);
...
friend Bool_t operator==(const TTimeStamp64 &lhs, const TTimeStamp64 &rhs);
friend Bool_t operator!=(const TTimeStamp64 &lhs, const TTimeStamp64 &rhs);
friend Bool_t operator< (const TTimeStamp64 &lhs, const TTimeStamp64 &rhs);
friend Bool_t operator<=(const TTimeStamp64 &lhs, const TTimeStamp64 &rhs);
friend Bool_t operator> (const TTimeStamp64 &lhs, const TTimeStamp64 &rhs);
...
public:
   ...
   void         Add(const TTimeStamp64 &offset);
   ...
   ClassDef(TTimeStamp64,1)  //Encapsulates seconds and ns since EPOCH
};


inline Bool_t operator==(const TTimeStamp64 &lhs, const TTimeStamp64 &rhs)
