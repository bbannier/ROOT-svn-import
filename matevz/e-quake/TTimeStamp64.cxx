...
//////////////////////////////////////////////////////////////////////////
//
// The TTimeStamp64 encapsulates seconds and ns since EPOCH
//
...
//
// Due to ROOT/CINT limitations TTimeStamp64 does not explicitly
...
ClassImp(TTimeStamp64);


TVirtualMutex *gTimeMutex = 0; // local mutex

//______________________________________________________________________________
ostream& operator<<(ostream& os, const TTimeStamp64& ts)
{
...
//______________________________________________________________________________
TBuffer &operator>>(TBuffer &buf, TTimeStamp64 &ts)
{
...
//______________________________________________________________________________
TBuffer &operator<<(TBuffer &buf, const TTimeStamp64 &ts)
{
   // Write time stamp to TBuffer.

   ((TTimeStamp64&)ts).Streamer(buf);
   return buf;
}

//______________________________________________________________________________
TTimeStamp64::TTimeStamp64()
{
   // Default ctor. Create a TTimeStamp64 and set it to the current time
...
//______________________________________________________________________________
TTimeStamp64::TTimeStamp64(UInt_t year, UInt_t month,
                       UInt_t day,  UInt_t hour,
                       UInt_t min,  UInt_t sec,
                       UInt_t nsec,
                       Bool_t isUTC, Int_t secOffset)
{
   // Create a TTimeStamp64 and set it to the specified year, month,
   ...
   //    TTimeStamp64(year,month,day,hour,min,sec,nsec,kFALSE,0);
   // or
   //    Int_t secOffset = 8*60*60;
   //    TTimeStamp64(year,month,day,hour,min,sec,nsec,kTRUE,8*60*60);

   Set(year, month, day, hour, min, sec, nsec, isUTC, secOffset);
}

//______________________________________________________________________________
TTimeStamp64::TTimeStamp64(UInt_t date, UInt_t time,
                       UInt_t nsec,
                       Bool_t isUTC, Int_t secOffset)
{
   // Create a TTimeStamp64 and set it to the specified date, time, nanosec.
   // If !isUTC then it is assumed to be the standard local time zone.
...
//______________________________________________________________________________
TTimeStamp64::TTimeStamp64(UInt_t tloc, Bool_t isUTC, Int_t secOffset, Bool_t dosDate)
{
   // Create a TTimeStamp64 and set it to tloc which must be a time_t value
...
//______________________________________________________________________________
const Char_t *TTimeStamp64::AsString(Option_t *option) const
{
   ...
   if (opt.Contains("2")) {
      ...
      sprintf(formatted[ibuffer], "{%lld,%d}", fSec, fNanoSec);
...
//______________________________________________________________________________
void TTimeStamp64::Copy(TTimeStamp64 &ts) const
{
   // Copy this to ts.
...
//______________________________________________________________________________
UInt_t TTimeStamp64::GetDate(Bool_t inUTC, Int_t secOffset,
...
//______________________________________________________________________________
UInt_t TTimeStamp64::GetTime(Bool_t inUTC, Int_t secOffset,
...
//______________________________________________________________________________
Int_t TTimeStamp64::GetDayOfYear(Bool_t inUTC, Int_t secOffset) const
{
...
//______________________________________________________________________________
Int_t TTimeStamp64::GetDayOfWeek(Bool_t inUTC, Int_t secOffset) const
{
...
//______________________________________________________________________________
Int_t TTimeStamp64::GetMonth(Bool_t inUTC, Int_t secOffset) const
{
...
//______________________________________________________________________________
Int_t TTimeStamp64::GetWeek(Bool_t inUTC, Int_t secOffset) const
{
...
//______________________________________________________________________________
Bool_t TTimeStamp64::IsLeapYear(Bool_t inUTC, Int_t secOffset) const
{
...
//______________________________________________________________________________
Int_t TTimeStamp64::GetZoneOffset()
{
...
//______________________________________________________________________________
void TTimeStamp64::Add(const TTimeStamp64 &offset)
{
...
//______________________________________________________________________________
void TTimeStamp64::Print(Option_t *option) const
{
   // Print date and time.
...
void TTimeStamp64::Set()
{
   ...
   // Jan 1, 1601. TTimeStamp64 uses time in 100ns ticks since Jan 1, 1970,
...
//______________________________________________________________________________
void TTimeStamp64::Set(Int_t year, Int_t month, Int_t day,
                     ...
                     Int_t nsec, Bool_t isUTC, Int_t secOffset)
{
   ...
   if (utc_sec == bad_time_t)
      Error("TTimeStamp64::Set","mktime returned -1");
...
//______________________________________________________________________________
void TTimeStamp64::Set(Int_t date, Int_t time, Int_t nsec,
                     Bool_t isUTC, Int_t secOffset)
{
...
//______________________________________________________________________________
void TTimeStamp64::Set(UInt_t tloc, Bool_t isUTC, Int_t secOffset, Bool_t dosDate)
{
...
//______________________________________________________________________________
void TTimeStamp64::NormalizeNanoSec()
{
...
//______________________________________________________________________________
time_t TTimeStamp64::MktimeFromUTC(tm_t *tmstruct)
{
...
//______________________________________________________________________________
Int_t TTimeStamp64::GetDayOfYear(Int_t day, Int_t month, Int_t year)
{
...
//______________________________________________________________________________
Int_t TTimeStamp64::GetDayOfWeek(Int_t day, Int_t month, Int_t year)
{
   // Method is using Zeller's formula for calculating the day number.
   // Valid return values range between 1 and 7, where Monday = 1.
...
//______________________________________________________________________________
Int_t TTimeStamp64::GetWeek(Int_t day, Int_t month, Int_t year)
{
   // Get the week of the year. Valid week values are between 1 and 53.
   // The return value is the year*100+week (1 Jan may be in the last
   // week of the previous year so the year must be returned too).
...
//______________________________________________________________________________
Bool_t TTimeStamp64::IsLeapYear(Int_t year)
{
...
//______________________________________________________________________________
void TTimeStamp64::DumpTMStruct(const tm_t &tmstruct)
{
