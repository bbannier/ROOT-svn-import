...
ReflexUnitTest::fundamental_type() {
   Fundamental itype(Dictionary::Main(), "myInt",sizeof(myInt),typeid(myInt));
...
ReflexUnitTest::type_base() {
  {
    Fundamental f(Dictionary::Main(), "fundamental",0,typeid(UnknownType));
...
ReflexUnitTest::pointer_type() {
  Fundamental f(Dictionary::Main(), "fundamental",0,typeid(UnknownType));
  Pointer fp(Dictionary::Main(), f.ThisType(),typeid(void*));
...
ReflexUnitTest::array_type() {
  ...
  Array fa(Dictionary::Main(), f, 10, typeid(float[10]));
...
ReflexUnitTest::typedef_type() {
  ...
  Typedef my_i(Dictionary::Main(), "myInt", Type::ByName("int"));
  Typedef your_i(Dictionary::Main(), "yourInt", Type::ByName("myInt"));
...
ReflexUnitTest::namespace_scope() {
  {
    Namespace ns(Dictionary::Main(), "Namespace");
    ...
    Namespace s1(Dictionary::Main(), "Namespace::Subspace1");
    Namespace s2(Dictionary::Main(), "Namespace::Subspace2");
...
ReflexUnitTest::namespace_members() {
  Namespace n(Dictionary::Main(), "Members");
  ...
  params.push_back(i);
  params.push_back(f);
  Function fun(Dictionary::Main(), f, params, typeid(void (void)) );
...
ReflexUnitTest::function_member() {
  ...
  Function fun(Dictionary::Main(), Type::ByName("float"),params,typeid(void (void)) );
...
ReflexUnitTest::class_type() {
  {
    Class _foo(Dictionary::Main(), "foo", sizeof(foo), typeid(foo));
    Class _bar(Dictionary::Main(), "bar", sizeof(bar), typeid(bar));
...
ReflexUnitTest::type_template() {
  Namespace _n(Dictionary::Main(), "mmm");
  ClassTemplateInstance _cti(Dictionary::Main(), 
                             "mmm::template<int,float,dummy>",
                             1,
                             typeid(UnknownType),
                             0);
...
ReflexUnitTest::object_value() {
  ...
  // pointer assignemnt
  CPPUNIT_ASSERT(0 == strcmp(pc, &vpc.Value<char>()));
  const char* pc2 = "azimut";
  vpc.Assign(pc2);
  CPPUNIT_ASSERT(0 == strcmp(pc2, &vpc.Value<char>()));
