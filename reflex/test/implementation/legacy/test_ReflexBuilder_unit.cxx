...
ReflexBuilderUnitTest::classbuilder() {
  ClassBuilderT<a::bar>(Dictionary::Main(), STRUCT)
  ...
  ClassBuilderT<a::foo>(Dictionary::Main())
  ...
  CPPUNIT_ASSERT_EQUAL( t.Id(), TypeBuilder(Dictionary::Main(), "::a::foo").Id());
...
ReflexBuilderUnitTest::propertybuilder() {
  ...
  ClassBuilderT<b::foo>(Dictionary::Main())
...
ReflexBuilderUnitTest::inheritancebuilder() {
  ClassBuilderT<c::base>(Dictionary::Main(), VIRTUAL).AddDataMember<int>("b", OffsetOf(c::base, b));
  ClassBuilderT<c::dev>(Dictionary::Main()).AddBase<c::base>().AddDataMember<int>("d", OffsetOf(c::dev, d));
  ClassBuilderT<c::dev1>(Dictionary::Main()).AddBase<c::base>(VIRTUAL).AddDataMember<int>("d1", OffsetOf(c::dev1, d1));
  ClassBuilderT<c::dev2>(Dictionary::Main()).AddBase<c::base>(VIRTUAL).AddDataMember<int>("d2", OffsetOf(c::dev2, d2));
  ClassBuilderT<c::dia>(Dictionary::Main()).AddBase<c::dev1>().AddBase<c::dev2>().AddDataMember<int>("dd", OffsetOf(c::dia, dd));
...
ReflexBuilderUnitTest::datamemberaccess() {
  ClassBuilderT<d::foo>(Dictionary::Main()).AddDataMember<int>("i", OffsetOf(d::foo, i) );
...
ReflexBuilderUnitTest::methodinvocation() {
  ClassBuilderT<e::foo>(Dictionary::Main()).AddFunctionMember<int(int,int)>("add", &foo_stub);
...
ReflexBuilderUnitTest::objectinstantiation() {
  ClassBuilderT<f::foo>(Dictionary::Main())
...
ReflexBuilderUnitTest::typedefbuilder() {
  TypedefBuilder<int>(Dictionary::Main(), "MyInt1").AddProperty("owner","me").AddProperty("price",10.0);
  ...
  NamespaceBuilder(Dictionary::Main(), "AA");
  TypedefBuilder<float>(Dictionary::Main(), "AA::MyInt1");
...
ReflexBuilderUnitTest::classAddTypedef() {
  ClassBuilderT<classWithTypedefs>(Dictionary::Main())
...
ReflexBuilderUnitTest::enumbuilder() {
  EnumBuilderT<enum1>(Dictionary::Main()).AddItem("a", val_a).AddItem("b", val_b).AddItem("c", val_c);
  EnumBuilderT<g::enum2>(Dictionary::Main()).AddItem("i", g::i).AddItem("j", g::j).AddItem("k", g::k);
...
ReflexBuilderUnitTest::classAddEnum() {
  ClassBuilderT<classWithEnums>(Dictionary::Main())
...
ReflexBuilderUnitTest::freefunctionbuilder() {
  NamespaceBuilder h(Dictionary::Main(), "h");
  FunctionBuilderT<int(int)>(Dictionary::Main(), "h::func",func_stub,0,0,0);
  FunctionBuilderT<int(int)>(Dictionary::Main(), "gfunc",0,0,0,0);
  ...
  Type t = Type::ByTypeInfo(typeid(int(int)));
   CPPUNIT_ASSERT(t);
  FunctionBuilder(Dictionary::Main(), t,"g::func2",func_stub,0,0,0);
...
ReflexBuilderUnitTest::freevariablebuilder() {
  NamespaceBuilder sh(Dictionary::Main(), "h");
  VariableBuilderT<int>(Dictionary::Main(), "h::s_i",(size_t)&h::s_i,STATIC);
  ...
  VariableBuilderT<int>(Dictionary::Main(), "s_j",99);
...
ReflexBuilderUnitTest::forwarddeclarations() {
  Type t_f  = TypeBuilder(Dictionary::Main(), "ftype");
  Type t_fp = PointerBuilder(Dictionary::Main(), t_f);
  Type t_fr = ReferenceBuilder(Dictionary::Main(), t_f);
  Type t_ftb = FunctionTypeBuilder(Dictionary::Main(), t_fr,t_fp);
  ClassBuilderT<i::foo>(Dictionary::Main())
...
ReflexBuilderUnitTest::subscopebuilder() {
  NamespaceBuilder(Dictionary::Main(), "j");

  ClassBuilderT<j::base1> classBuilder1 (Dictionary::Main());

  ClassBuilderT<j::derived1> classBuilder2 (Dictionary::Main());
  classBuilder2.AddBase<j::base1>().AddDataMember<int>("i", OffsetOf(j::derived1, i));

  ClassBuilderT<j::base2> classBuilder3 (Dictionary::Main() );

  ClassBuilderT<j::derived2> classBuilder4 (Dictionary::Main());
  classBuilder4.AddBase<j::base2>().AddDataMember<int>("i", OffsetOf(j::derived2, i));
...
ReflexBuilderUnitTest::type_equivalence() {
  TypedefBuilder<int>(Dictionary::Main(), "MyInt");
  ...
  Type f1p = PointerBuilder(Dictionary::Main(), f1);
  Type f2p = PointerBuilder(Dictionary::Main(), f2);
  Type f3p = PointerBuilder(Dictionary::Main(), f3);
  Type f4p = PointerBuilder(Dictionary::Main(), f4);
  Type f5p = PointerBuilder(Dictionary::Main(), f5);
...
ReflexBuilderUnitTest::type_template() {
  NamespaceBuilder(Dictionary::Main(), "std");
  ClassBuilderT<std::vector<int> > classBuilder0(Dictionary::Main());
  ClassBuilderT<std::vector<float> > classBuilder1(Dictionary::Main());
  ClassBuilderT<std::map<int, int> > classBuilder2(Dictionary::Main());
  ClassBuilderT<std::map<int, float> > classBuilder3(Dictionary::Main());
  ClassBuilderT<std::map<float, std::string> > classBuilder4(Dictionary::Main(), "std::map<float, std::string>");
  ClassBuilderT<std::list<std::string> > classBuilder5(Dictionary::Main());
...
ReflexBuilderUnitTest::member_template() {
  ClassBuilderT<MyMemberTemplateClass>(Dictionary::Main())
  ...
  FunctionBuilderT<void(int)>(Dictionary::Main(), "TTT::foo<int>",0,0,"t",0);
  FunctionBuilderT<void(float)>(Dictionary::Main(), "TTT::foo<float>",0,0,"t",0);
  FunctionBuilderT<void(bool) >(Dictionary::Main(), "TTT::foo<bool>",0,0,"t",0);
  FunctionBuilderT<void(int,int)>(Dictionary::Main(), "TTT::foo<int,int>",0,0,"t0;t1",0);
  FunctionBuilderT<void(bool, float)>(Dictionary::Main(), "TTT::foo<bool,float>",0,0,"t0;t1",0);
  FunctionBuilderT<void(bool,bool)>(Dictionary::Main(), "TTT::foo<bool,bool>",0,0,"t0;t1",0);
  FunctionBuilderT<void(int,int)>(Dictionary::Main(), "TTT::bar<int,int>",0,0,"t0;t1",0);
  FunctionBuilderT<void(bool,float)>(Dictionary::Main(), "TTT::bar<bool,float>",0,0,"t0;t1",0);
  FunctionBuilderT<void(bool,bool)>(Dictionary::Main(), "TTT::bar<bool,bool>",0,0,"t0;t1",0);
  ...
  ClassBuilderT<std::string> classBuilder1(Dictionary::Main());
  ClassBuilderT<std::string>(Dictionary::Main(), "std::string");
  FunctionBuilderT<void(int)>(Dictionary::Main(), "foo<int>",0,0,"t",0);
  FunctionBuilderT<void(float)>(Dictionary::Main(), "foo<float>",0,0,"t",0);
  FunctionBuilderT<void(std::string)>(Dictionary::Main(), "foo<std::string>",0,0,"t",0);
  FunctionBuilderT<void(int,int)>(Dictionary::Main(), "foo<int,int>",0,0,"t0;t1",0);
  FunctionBuilderT<void(bool, float)>(Dictionary::Main(), "foo<bool,float>",0,0,"t0;t1",0);
  FunctionBuilderT<void(bool,bool)>(Dictionary::Main(), "foo<bool,bool>",0,0,"t0;t1",0);
  FunctionBuilderT<void(int,int)>(Dictionary::Main(), "bar<int,int>",0,0,"t0;t1",0);
  FunctionBuilderT<void(bool,float)>(Dictionary::Main(), "bar<bool,float>",0,0,"t0;t1",0);
  FunctionBuilderT<void(bool,bool)>(Dictionary::Main(), "bar<bool,bool>",0,0,"t0;t1",0);
...
ReflexBuilderUnitTest::bases() {
   ClassBuilder(Dictionary::Main(), "cc::dev", typeid(cc::dev), sizeof(cc::dev), PUBLIC | CLASS | ABSTRACT | VIRTUAL)
      .AddBase(TypeBuilder(Dictionary::Main(), "cc::base"), BaseOffset<cc::dev, cc::base >::Get(), VIRTUAL | PUBLIC);
   ...
   ClassBuilder(Dictionary::Main(), "cc::base", typeid(cc::base), sizeof(cc::base), PUBLIC | CLASS);
...
ReflexBuilderUnitTest::hiddentypes() {
   TypeBuilder(Dictionary::Main(), "MyType",0);
   ...
   TypedefTypeBuilder(Dictionary::Main(), "MyType", t0);
   ...
   ClassBuilder(Dictionary::Main(), "MyType", typeid(void), 0, 0 );
