...
namespace cling {
  ...
  Expr *ASTTransformVisitor::BuildEvalArg0(ASTContext &C) {
    ...
    SemaPtr->ImpCastExprToType(Arg0, CastTo, CK_ArrayToPointerDecay);
  ...
  Expr *ASTTransformVisitor::BuildEvalArg1(ASTContext &C) {
    ...
    Expr *Arg1 = SemaPtr->BuildCompoundLiteralExpr(SourceLocation(), C.CreateTypeSourceInfo(VarAddrTy), SourceLocation(), ILE).takeAs<CompoundLiteralExpr>();
    SemaPtr->ImpCastExprToType(Arg1, C.getPointerType(C.VoidPtrTy), CK_ArrayToPointerDecay);
  ...
  Expr *ASTTransformVisitor::BuildEvalArg2(ASTContext &C) {
    ...
    SemaPtr->ImpCastExprToType(Arg2, DeclContextTy, CK_IntegralToPointer);
