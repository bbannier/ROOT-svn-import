...
$(MATHCOREDS):  $(MATHCOREDH1) $(MATHCOREL) $(MATHCORELINC) $(MATHCOREO) $(ROOTCINTNEW)
		@echo "Generating dictionary $@..."
		@echo "for files $(MATHCOREDH1)"
		$(ROOTCINTNEW) -f $@ -o "$(MATHCOREO)" -c $(MATHCOREDH1) $(MATHCOREL)
...
$(MATHCOREDS32):$(MATHCOREDH132) $(MATHCOREL) $(MATHCORELINC) $(MATHCOREO) $(ROOTCINTNEW)
		@echo "Generating dictionary $@..."
		@echo "for files $(MATHCOREDH132)"
		$(ROOTCINTNEW) -f $@ -o "$(MATHCOREO)" -c $(MATHCOREDH132) $(MATHCOREL32)
