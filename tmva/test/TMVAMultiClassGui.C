...
{   
   ...
   while ((str = (TObjString*)it())) {
      ...
      ActionButton( cbar, 
                    ...
                    Form( ".x variablesMultiClass.C(\"%s\",\"%s\",\"%s\")", fName, str->GetString().Data(), title.Data() ),
                    Form( "Plots all '%s'-transformed input variables (macro variablesMultiClass.C(...))", str->GetString().Data() ),
   ...
   while ((str = (TObjString*)it())) {
      ...
      ActionButton( cbar, 
                    Form( "(%i%c) %s", ic, ch++, title.Data() ),
                    Form( ".x CorrGuiMultiClass.C(\"%s\",\"%s\",\"%s\")", fName, str->GetString().Data(), title.Data() ),
                    Form( "Plots all correlation profiles between '%s'-transformed input variables (macro CorrGuiMultiClass.C(...))", 
                          str->GetString().Data() ),
                    buttonType, str->GetString() );
   }      
   ...
   ActionButton( cbar,  
                 title,
                 Form( ".x correlationsMultiClass.C(\"%s\")", fName ),
                 "Plots signal and background correlation summaries for all input variables (macro correlationsMultiClass.C)", 
                 buttonType );
