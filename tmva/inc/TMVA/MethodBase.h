...
namespace TMVA {
   ...
   public:
      ...
      const std::vector<const TMVA::Event*>& GetEventCollection( Types::ETreeType type );
   ...
   private:
      ...
      mutable std::vector<const std::vector<const TMVA::Event*>*> fEventCollections; // if the method needs the complete event-collection, the transformed event coll. ist stored here.
