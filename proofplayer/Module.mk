...
$(PROOFPLAYERDS): $(PROOFPLAYERH) $(PROOFPLAYERL) $(PROOFPLAYERO) $(ROOTCINTTMPEXE)
		@echo "Generating dictionary $@..."
		$(ROOTCINTTMPEXE) -f $@ -o "$(PROOFPLAYERO)" -c $(PROOFPLAYERH) $(PROOFPLAYERL)
...
$(PROOFDRAWDS): $(PROOFDRAWH) $(PROOFDRAWL) $(PROOFDRAWO) $(ROOTCINTTMPEXE)
		@echo "Generating dictionary $@..."
		$(ROOTCINTTMPEXE) -f $@ -o "$(PROOFDRAWO)" -c $(PROOFDRAWH) $(PROOFDRAWL)
