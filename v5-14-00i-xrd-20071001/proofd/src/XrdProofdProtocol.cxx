...
static XrdSysLogger   gForkLogger;
...
XrdSysError           XrdProofdProtocol::fgEDest(0, "Proofd");
...
int XrdProofdProtocol::Login()
{
   ...
   if (fClientID) {
      ...
      TRACEP(XERR,"Login: no space for ClientID");
      fResponse.Send(kXR_InvalidRequest,"Login: unknown ClientID");
...
int XrdProofdProtocol::MapClient(bool all)
{
   ...
   if (pmgr) {
      ...
      XrdOucString udir = fUI.fHomeDir;
      if (fgWorkDir) {
      ...
      {  XrdSysMutexHelper mtxh(&fgXPDMutex);
         ...
         pmgr = new XrdProofClient(this, clientvers, udir.c_str());
      }
...
//__________________________________________________________________________
int XrdProofClient::CreateUNIXSock(XrdSysError *edest, char *tmpdir)
{
