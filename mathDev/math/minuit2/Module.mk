...
ifneq ($(USE_OPENMP),)
$(MINUIT2O): CXXFLAGS += -DMINUIT2_THREAD_SAFE -DMINUIT2_PARALLEL_OPENMP -D_GLIBCXX_PARALLEL -fopenmp
#math/minuit2/src/ParallelNumericalGC.o: CXXFLAGS += -D_GLIBCXX_PARALLEL -fopenmp 
endif
endif
