...
function(ROOT_LINKER_LIBRARY library)
  ...
  if(WIN32 AND NOT ARG_DLLEXPORT)
	...
	foreach(src ${lib_srcs})
	  ...
	  set(lib_objs ${lib_objs} ${CMAKE_CURRENT_BINARY_DIR}/CMakeFiles/${library}.dir/${obj})
	endforeach()
    #---create a shared library with the .def file------------------------
    add_library(${library} SHARED ${lib_srcs} ${library}.def)
	...
	#get_target_property(objects ${library} RULE_LAUNCH_LINK)
