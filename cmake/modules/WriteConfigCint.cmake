...
function(WRITE_CONFIG_CINT file)
  write_file(${file} "/* Generated by WriteConfigCint.cmake*/")
    ...
    write_file(${file} "#define G__CFG_CFLAGS \"${CMAKE_C_FLAGS} ${CINT_C_DEFINITIONS} -I${CMAKE_INSTALL_PREFIX}/include -I${CMAKE_BINARY_DIR}/include\" " APPEND)
    ...
    write_file(${file} "#define G__CFG_CXXFLAGS \" ${CMAKE_CXX_FLAGS} ${CINT_CXX_DEFINITIONS} -I${CMAKE_INSTALL_PREFIX}/include -I${CMAKE_BINARY_DIR}/include\"" APPEND)
...
#      write_file(${file} "#define G__CFG_DEBUG \"$(DEBUG)\"" APPEND) #TODO
...
#    ENDIF(CMAKE_BUILD_TYPE MATCHES DEBUG)
    ...
    write_file(${file} "#define G__CFG_CINTSYSDIR \"${CMAKE_INSTALL_PREFIX}\"" APPEND)
    write_file(${file} "#define G__CFG_HAVE_CONFIG \"1\"" APPEND)
    write_file(${file} "#define CINTSYSDIR \"${CMAKE_INSTALL_PREFIX}\"" APPEND)
    write_file(${file} "#define G__CFG_MAKEIMPLIB \"\"" APPEND)
    write_file(${file} "#define G__CFG_HAVE_CONFIG \"1\"" APPEND)
  #endif()  
endfunction()
