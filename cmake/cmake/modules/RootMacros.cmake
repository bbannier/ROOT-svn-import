...
#  Message("_libname: ${_libname}")
  Set(OUTFILE "${CMAKE_LIBRARY_OUTPUT_DIRECTORY}/lib${LIBNAME}.rootmap")
  Set(INFILE "${CMAKE_LIBRARY_OUTPUT_DIRECTORY}/lib${LIBNAME}.so")
#  Message("OutFILE: ${OUTFILE}")
#  Message("InFILE: ${INFILE}")
  ...
  If(${ARGC} GREATER 2)
    Set(_dependencies)
    ForEach(_file ${ARGN})
      Set(_dependencies ${_dependencies} ${CMAKE_LIBRARY_OUTPUT_DIRECTORY}/lib${_file}.so)
