...
TMVADS1      := $(subst $(SRCDIR)/,,$(MODDIRS))/G__TMVA1.cxx
TMVADS2      := $(subst $(SRCDIR)/,,$(MODDIRS))/G__TMVA2.cxx
TMVADS3      := $(subst $(SRCDIR)/,,$(MODDIRS))/G__TMVA3.cxx
TMVADS4      := $(subst $(SRCDIR)/,,$(MODDIRS))/G__TMVA4.cxx
