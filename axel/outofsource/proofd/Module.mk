...
XPCONNO      := $(MODDIRB)/XrdProofConn.o $(MODDIRB)/XrdProofPhyConn.o \
                $(MODDIRB)/XProofProtUtils.o
...
PROOFDEXEO   := $(subst $(SRCDIR)/,,$(PROOFDEXES:.cxx=.o))
