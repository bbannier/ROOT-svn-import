...
\lstinputlisting{code_snippits/RooAbsPdf.h}
...
\lstinputlisting[firstline=2,lastline=13]{GaussianModel.C}
or using the workspace factory syntax via
\lstinputlisting[firstline=2,lastline=6]{GaussianModel_factory.C}
...
\lstinputlisting{code_snippits/TestStatistic.h}

\lstinputlisting{code_snippits/TestStatSampler.h}

\lstinputlisting{code_snippits/SamplingDistribution.h}
...
\newpage
%\lstinputlisting[firstline=26, lastline=296]{code_snippits/SimplestIntervalExample.C}

\lstinputlisting[firstline=1, lastline=296]{code_snippits/IntervalExamples.C}
...
% Question is whether notation should be introduced here when it is introduced in detail under ``Profile Likelihood Calculator''
