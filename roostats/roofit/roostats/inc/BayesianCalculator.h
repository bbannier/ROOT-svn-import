...
namespace RooStats {
   ...
   public:
      ...
      //                    niter defines here the max numnber of function calls - can be reduced to make it faster
      //                    but the required tolerance will not be reached 
      //       VEGAS   MC integration method based on importance sampling - niter is number of calls + extra parameter
      //                can be configured using  IntegratorMultiDimOptions class
      ...
      //       PLAIN    simple MC integration method, niter defines number of calls 
      //
      ...
      //    1-TOYMC  : same method as before but in this case the toys are generated for each poi value
      //
      //    ROOFIT: 
