...
$(SPECTRUMPAINTERDS): $(SPECTRUMPAINTERH) $(SPECTRUMPAINTERL) $(SPECTRUMPAINTERO) $(ROOTCINTTMPEXE)
		@echo "Generating dictionary $@..."
		$(ROOTCINTTMPEXE) -f $@ -o "$(SPECTRUMPAINTERO)" -c $(SPECTRUMPAINTERH) $(SPECTRUMPAINTERL)
