...
$(RAUTHDS):     $(RAUTHH) $(RAUTHL) $(RAUTHO) $(ROOTCINTTMPEXE)
		@echo "Generating dictionary $@..."
		$(ROOTCINTTMPEXE) -f $@ -o "$(RAUTHO)" -c $(RAUTHH) $(RAUTHL)
...
$(AFSAUTHDS):   $(AFSAUTHH) $(AFSAUTHL) $(AFSAUTHO) $(ROOTCINTTMPEXE)
		@echo "Generating dictionary $@..."
		$(ROOTCINTTMPEXE) -f $@ -o "$(AFSAUTHO)" -c $(AFSAUTHH) $(AFSAUTHL)
