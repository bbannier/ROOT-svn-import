...
public:
  ...
  GAAlleleSet(const T& _lower, const T& _upper, 
	      GAAllele::BoundType lb=GAAllele::INCLUSIVE, 
	      GAAllele::BoundType ub=GAAllele::INCLUSIVE) :
  core(new GAAlleleSetCore<T>(_lower, _upper, lb, ub)) {}
  GAAlleleSet(const T& _lower, const T& _upper, const T& increment,
	      GAAllele::BoundType lb=GAAllele::INCLUSIVE, 
	      GAAllele::BoundType ub=GAAllele::INCLUSIVE) :
  core(new GAAlleleSetCore<T>(_lower, _upper, increment, lb, ub)) {}
