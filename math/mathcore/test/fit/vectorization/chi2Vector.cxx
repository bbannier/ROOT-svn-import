...
//
// Testing/Benchmark program for the vectorization 
...
// calls stressVector twice one time for the non vectorized version 
// ans once for the vectorized version. 
//
// The results are written to the file given as the first argument or 
// to the file "result.txt" by default. 
//
int main(int argc, char *argv[])
{
   ...
   if ( argc > 1 )
      ...
      outFile.open( "result.txt", fstream::out );
   ...
   for( int i=0; i < MaxExp; i++ )
   {
      ...
      std::cout << "Performance Test with: " << NBins << std::endl;
