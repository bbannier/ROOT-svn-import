#define procRates_cxx
// The class definition in procRates.h has been generated automatically
...
//
// Root > T->Process("procRates.C")
// Root > T->Process("procRates.C","some options")
// Root > T->Process("procRates.C+")
//
...
void procRates::Begin(TTree * /*tree*/)
{
...
void procRates::SlaveBegin(TTree *tree)
{
...
Bool_t procRates::Process(Long64_t entry)
{
   // The Process() function is called for each entry in the tree (or possibly
   // keyed object in the case of PROOF) to be processed. The entry argument
   // specifies which entry in the currently loaded tree is to be processed.
   // It can be passed to either procRates::GetEntry() or TBranch::GetEntry()
...
void procRates::Terminate()
{
   ...
   gROOT->Reset();
   TCanvas* c1 = new TCanvas("c1", "procRates");
   c1->SetGrid();

   TGraph* gr1 = new TGraph(fMaxTime + 1, x1, y1);
   gr1->Draw("ACP");
//   gr1->Draw("LC*");
   Color_t ci = TColor::GetColor("#66cc99");
   gr1->SetMarkerColor(ci);
